...
if(sessionStorage.getItem("theme")){
    ...
    HTML.dataset.theme = isDark ? "dark" :"dark";
...
let changeTheme =  ()=>{
    HTML.dataset.theme = sessionStorage.getItem("theme")=== "dark" ? "dark" : "dark";
...
const titles = ["Front-End Developer", "Web Developer"]; // Add other titles you want to cycle through
let currentIndex = 0;
